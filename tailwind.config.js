  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        'public-pixel': ['PublicPixel', 'Courier New', 'monospace'],
        'retro': ['PublicPixel', 'Courier New', 'monospace'],
      },
    },
  },
  plugins: [
      ...
      matchUtilities(
        {
          'game-pixel-container-progress-fill': (value) => {
            return {
              'border-image-source': 'url("/assets/ui/pixel_style/container_pixel_progress_fill.png")',
      ...
      matchUtilities(
        {
          'game-3d-container-progress-fill': (value) => {
            return {
              'border-image-source': 'url("/assets/ui/3d_style/container_3d_progress_fill.png")',
